import { Component, Input, ContentChildren, QueryList, HostBinding, ChangeDetectionStrategy } from '@angular/core';
...
export class TableComponent<T extends Row = Row> {
  ...
  @ContentChildren(ColumnComponent, { descendants: true }) columns!: QueryList<ColumnComponent<T>>;
